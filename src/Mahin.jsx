...
import productData from "./mahin.json";
import Navbar from "./Navbar";

const Mahin = () => {
	return (
		<div className="">
      <Navbar title="Stock of Mahin" />
			<h2 className="text-2xl text-center font-semibold my-8">T-Shirt Products - ({productData?.productDetails.update})</h2>
			...
			<h2 className="text-2xl text-center font-semibold my-8">Pant Products - ({productData?.productDetails.update})</h2>
			<table className="w-full mx-auto shadow-lg rounded-lg">
				<thead>
					<tr>
						<th className="border text-left px-4 py-2">Product Name</th>
